...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.lng = factory());
  ...
  var TextTextureRenderer = /*#__PURE__*/function () {
    ...
    _createClass(TextTextureRenderer, [{
      ...
      value: function setFontProperties() {
        this._context.font = Utils$1.isSpark ? this._stage.platform.getFontSetting(this) : this._getFontSetting();
  ...
  var Stage = /*#__PURE__*/function (_EventEmitter) {
    ...
    function Stage() {
      ...
      if (context) {
        ...
        if (Utils$1.isWeb && (!Stage.isWebglSupported() || _this.getOption('canvas2d'))) {
  ...
  var Application = /*#__PURE__*/function (_Component) {
    ...
    _createClass(Application, [{
      ...
      value: function fireTopDownScrollWheelHandler(event) {
      ...
      key: "fireTopDownClickHandler",
      value: function fireTopDownClickHandler(obj) {
        var _this5 = this;
        ...
        var clickableChildren = this._withinClickableRange(affected, clientX, clientY);

        if (clickableChildren.length) {
          clickableChildren.sort(function (a, b) {
            _newArrowCheck(this, _this5);

            return a.id > b.id ? 1 : -1;
          }.bind(this));
          var n = clickableChildren.length;

          while (n--) {
            var child = clickableChildren[n];
      ...
      key: "fireTopDownHoverHandler",
      value: function fireTopDownHoverHandler(obj) {
        var _this6 = this;
        ...
        if (hoverableChildren.length) {
          ...
          var n = hoverableChildren.length;

          while (n--) {
            var child = hoverableChildren[n];
      ...
      value: function _withinClickableRange(affectedChildren, cursorX, cursorY) {
        ...
        while (n--) {
          ...
          var ctx = child.core.renderContext;
